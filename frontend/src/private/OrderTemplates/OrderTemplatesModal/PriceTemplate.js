    ...
    <div className="form-group">
      <label htmlFor={props.id}>
        ...
        <span
          ...
          title="Specify a price or choose an index. Multiplying by 1 = 100%."
      ...
      <div className="input-group">
        <input
          ...
          placeholder="0"
          defaultValue={priceTemplate.price}
        />
        ...
        <input
          ...
          placeholder="1"
          defaultValue={priceTemplate.multiplier}
        />
