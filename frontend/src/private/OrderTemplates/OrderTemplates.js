...
import OrderTemplateModal, {
  DEFAULT_ORDER_TEMPLATE,
} from "./OrderTemplatesModal/OrderTemplateModal";
import {
  getOrderTemplates,
  deleteOrderTemplate,
} from "../../services/OrderTemplatesService";
import SearchSymbol from "../../components/SearchSymbol/SearchSymbol";
import NewOrderTemplateButton from "./NewOrderTemplateButton/NewOrderTemplateButton";
...
function OrderTemplates() {
  ...
  return (
    <React.Fragment>
      ...
      <OrderTemplateModal
        data={editOrderTemplate}
        onSubmit={onOrderTemplateSubmit}
      />
