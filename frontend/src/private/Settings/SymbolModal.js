...
function SymbolModal(props) {
  ...
  function getStarFillColor() {
    return symbol.isFavorit ? "yellow" : "white";
  }

  function onFavouriteClick(event) {
    setSymbol((prevState) => ({
      ...prevState,
      isFavorit: !symbol.isFavorit,
    }));
  }
                    ...
                    <div className="col-md-6 mb-3">
                      <div className="form-group">
                        ...
                        <input
                          ...
                          id="basePrecision"
                          placeholder="8"
                          defaultValue={symbol.basePrecision}
                          required
                    ...
                    <div className="col-md-6 mb-3">
                      <div className="form-group">
                        ...
                        <input
                          ...
                          id="quotePrecision"
                          placeholder="8"
                          defaultValue={symbol.quotePrecision}
                          required
                          onChange={onInputChange}
                        />
                      </div>
                    ...
                    <div className="col-md-6 mb-3">
                      <div className="form-group">
                        ...
                        <input
                          ...
                          id="minNotional"
                          placeholder="0.1"
                          defaultValue={symbol.minNotional}
                          required
                          onChange={onInputChange}
                        />
                      </div>
                    ...
                    <div className="col-md-6 mb-3">
                      <div className="form-group">
                        ...
                        <input
                          ...
                          id="minLotSize"
                          placeholder="0.1"
                          defaultValue={symbol.minLotSize}
                          required
                          onChange={onInputChange}
                        />
                      </div>
