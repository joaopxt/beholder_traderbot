...
export async function saveOrderTemplate(id, newOrderTemplate, token) {
  ...
  if (
    ...
    newOrderTemplate.quantityMultiplier = parseFloat(
      newOrderTemplate.quantityMultiplier.replace(",", ".")
    );
  }

  if (
    typeof newOrderTemplate.icebergQtyMultiplier === "string" &&
    regex.test(newOrderTemplate.icebergQtyMultiplier)
  ) {
    newOrderTemplate.icebergQtyMultiplier = parseFloat(
      newOrderTemplate.icebergQtyMultiplier.replace(",", ".")
    );
  }
  ...
  if (
    ...
    newOrderTemplate.limitPriceMultiplier = parseFloat(
  ...
  if (
    ...
    newOrderTemplate.stopPriceMultiplier = parseFloat(
