...
async function updateOrderTemplate(id, newOrderTemplate) {
  ...
  if (
    newOrderTemplate.icebergQty &&
    newOrderTemplate.icebergQty !== currentOrderTemplate.icebergQty
  )
    currentOrderTemplate.icebergQty = newOrderTemplate.icebergQty;

  if (
    newOrderTemplate.icebergQtyMultiplier &&
    newOrderTemplate.icebergQtyMultiplier !==
      currentOrderTemplate.icebergQtyMultiplier
  )
    currentOrderTemplate.icebergQtyMultiplier =
      newOrderTemplate.icebergQtyMultiplier;
