...
async function updateAutomation(id, newAutomation) {
  ...
  if (
    ...
    newAutomation.symbol !== currentAutomation.symbol
  ) {
  ...
  if (
    newAutomation.indexes &&
    newAutomation.indexes !== currentAutomation.indexes
  ) {
    currentAutomation.indexes = newAutomation.indexes;
  }

  if (
    newAutomation.conditions &&
    newAutomation.conditions !== currentAutomation.conditions
  ) {
